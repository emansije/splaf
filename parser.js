    ...
    parse: function(input, startRule) {
      ...
      function parse_statement() {
        ...
        if (result3 !== null) {
          ...
          if (result4 !== null) {
            var result12 = parse_attribution();
            if (result12 !== null) {
              var result5 = result12;
            } else {
              var result11 = parse_if();
              if (result11 !== null) {
                var result5 = result11;
              } else {
                var result10 = parse_while();
                if (result10 !== null) {
                  var result5 = result10;
                } else {
                  var result9 = parse_print();
                  if (result9 !== null) {
                    var result5 = result9;
                  } else {
                    var result8 = parse_prompt();
                    if (result8 !== null) {
                      var result5 = result8;
                    } else {
                      var result5 = null;;
      ...
      function parse_reserved() {
        ...
        var result4 = parse_functionname();
        if (result4 !== null) {
          var result0 = result4;
        } else {
          if (input.substr(pos, 6) === "come\xE7a") {
            var result3 = "come\xE7a";
            pos += 6;
          } else {
            var result3 = null;
            if (reportMatchFailures) {
      ...
      function parse_identifiername() {
        ...
        if (result3 !== null) {
          if (input.substr(pos).match(/^[a-zA-Z_\xE1\xE0\xE3\xE2\xE9\xED\xF3\xF5\xF4\xFA\xE7\xC1\xC0\xC3\xC2\xC9\xCD\xD3\xD5\xD4\xDA\xC7]/) !== null) {
            var result4 = input.charAt(pos);
            pos++;
          } else {
            var result4 = null;
            if (reportMatchFailures) {
              matchFailed("[a-zA-Z_\\xE1\\xE0\\xE3\\xE2\\xE9\\xED\\xF3\\xF5\\xF4\\xFA\\xE7\\xC1\\xC0\\xC3\\xC2\\xC9\\xCD\\xD3\\xD5\\xD4\\xDA\\xC7]");
            }
          }
          if (result4 !== null) {
            var result5 = [];
            if (input.substr(pos).match(/^[0-9a-zA-Z_\xE1\xE0\xE3\xE2\xE9\xED\xF3\xF5\xF4\xFA\xE7\xC1\xC0\xC3\xC2\xC9\xCD\xD3\xD5\xD4\xDA\xC7]/) !== null) {
              var result6 = input.charAt(pos);
              pos++;
            } else {
              var result6 = null;
              if (reportMatchFailures) {
                matchFailed("[0-9a-zA-Z_\\xE1\\xE0\\xE3\\xE2\\xE9\\xED\\xF3\\xF5\\xF4\\xFA\\xE7\\xC1\\xC0\\xC3\\xC2\\xC9\\xCD\\xD3\\xD5\\xD4\\xDA\\xC7]");
              }
            }
            while (result6 !== null) {
      ...
      function parse_expr() {
        ...
        var result2 = parse_binaryop();
        if (result2 !== null) {
          var result0 = result2;
        } else {
          var result1 = parse_unaryop();
          if (result1 !== null) {
            var result0 = result1;
          } else {
            var result0 = null;;
      ...
      function parse_identifier() {
        ...
        var savedPos0 = pos;
        var result1 = parse_identifiername();
        var result2 = result1 !== null
          ? (function(id) { 
                return {
                  type: "variable", 
            ...
            if (result5 !== null) {
              ...
              if (result6 !== null) {
                ...
                if (result7 !== null) {
                  var result8 = parse__();
                  if (result8 !== null) {
                    var result9 = parse_lb();
                    if (result9 !== null) {
                      if (input.substr(pos, 7) === "termina") {
                        var result10 = "termina";
                        pos += 7;
                      } else {
                        var result10 = null;
                        if (reportMatchFailures) {
      ...
      function parse_if() {
                            ...
                            if (result13 !== null) {
                              ...
                              if (result14 !== null) {
                                ...
                                if (result19 !== null) {
                                  ...
                                  if (result20 !== null) {
                                    var result21 = parse_lb();
                                    if (result21 !== null) {
                                      var result24 = parse_statement();
                                      if (result24 !== null) {
                                        var result22 = result24;
                                      } else {
                                        var result23 = parse_block();
                                        if (result23 !== null) {
        ...
        var result2 = result1 !== null
          ? (function(cond, ifval, elseval) {
              ...
              })(result1[2], result1[8], result1[12])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
